	...
	return (
		<>
			...
			<p>
					...
					prácticas. Lo que te permitirá identifica que es una buena práctica y un marco de trabajo, las
				...
				Adicionalmente se contextualizará el concepto, los factores, criterios y métricas de
					calidad de software. Con lo cual tendrás las bases para diferenciar las mejores prácticas que se pueden
