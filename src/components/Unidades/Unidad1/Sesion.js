									...
									<Accordion.Body>
															...
															{tema.subtemas.map((subtema, index) => (
																<div>
																	<div style={{ margin: "0 0 0 20px" }}>
																		1.{index_}.{index + 1} {subtema.titulo}
																	</div>
																</div>
															))}
														</>
										...
										{sesion.extra_clase.actividad_aprendizaje1.resource && (
											<Iframe
												...
												pdfFile={sesion.extra_clase.actividad_aprendizaje1.resource.pdf}
											/>
											...
											{sesion.sesion_aula.sesion_videoconferencia.temas.map((tema, index) => (
												<>
													<li>
														{tema.titulo}
														<ul>
															{tema.parrafos?.length > 0
																? tema.parrafos.map((parrafo) => <li>{parrafo}</li>)
																: ""}
														</ul>
													</li>
												</>
